...
@Component({
  ...
  standalone: true,
  imports: [BreadcrumbComponent, NavbarComponent, BarraPesquisaComponent, ModalButtonComponent, MenuLateralComponent, TabelaListaCompartilhadaComponent, BtnListaCompartilhadaComponent, BtnGrupoListaCompartilhadaComponent, SearchListaCompartilhadaComponent, TrackPageListaCompartilhadaComponent, BreadcrumbListaCompartilhadaComponent],

...
import { ModalExcluirEtapaComponent } from "../../components/gerenciamento-etapa-components/modal-excluir-etapa/modal-excluir-etapa.component";
...
@Component({
    ...
    imports: [NavbarComponent, MenuLateralEtapaComponent, BreadcrumbEtapaComponent, BarraPesquisaEtapaComponent, ModalCriarEtapaComponent, GerenciamentoEtapaComponentsComponent, ModalEditarEtapaComponent, ModalExcluirEtapaComponent]
})

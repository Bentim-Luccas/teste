...
@Component({
    ...
    imports: [NavbarComponent, BreadcrumbEtapaComponent, BarraPesquisaEtapaComponent, GerenciamentoEtapaComponentsComponent, BuscarEtapaComponent, TrackPageEtapaComponent, MenuLateralComponent, BtnModalCriarEtapa]
})

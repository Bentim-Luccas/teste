...
@Component({
    ...
    imports: [NavbarComponent, MenuLateralComponent, BarraPesquisaComponent, TabelaUsuariosComponent, CriacaoUsuarioModalComponent, CriacaoUsuarioModalButtonComponent]
})
